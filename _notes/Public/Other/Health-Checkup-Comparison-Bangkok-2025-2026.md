...
> รวบรวมโปรโมชั่นตรวจสุขภาพจาก **21 โรงพยาบาล** ในกรุงเทพฯ และปริมณฑล เพื่อเปรียบเทียบราคา รายการตรวจ และระยะเวลาโปรโมชั่น โดยราคาและเงื่อนไขเป็นข้อมูล ณ 9 พ.ค. 2026
...
| วิภาวดี 40th | **2,392** | 20,400-23,400 | - | 31 พ.ค. 2026 | ⚠️ ตรวจสอบรอบโปรโมชั่น |
| เจ้าพระยา | **3,200** | 5,400-6,600 | 14,000-20,700 | ปัจจุบัน | ✅ |
| ปิยะเวท | **3,500** | 7,700-10,000 | 24,000-28,000 | ปัจจุบัน | ✅ |
| สมิติเวช สุขุมวิท | **3,500** | 8,500-13,500 | 30,000-38,000 | 31 พ.ค. 2026 | ⚠️ ตรวจสอบรอบโปรโมชั่น |
...
| ธนบุรี บำรุงเมือง | **5,600** | Buy 1 Get 1 | 8,900 | ปัจจุบัน | ✅ ลด 50%+ |
...
| ศิครินทร์ (Sikarin) | Light | Silver | Gold | ปัจจุบัน | ดู GoWabi |
...
### Feature เด่น
- แบ่งแพ็กเกจตามช่วงอายุและเพศ
- Ultimate มีรายการตรวจ 51 รายการ
...
> ⚠️ โปรโมชั่นนี้ระบุวันสิ้นสุด **31 พฤษภาคม 2026** ควรตรวจสอบโปรโมชั่นรอบใหม่กับโรงพยาบาล
...
- มีบริการตรวจสุขภาพก่อนแต่งงานด้วย
...
- ราคารวมค่าแพทย์แล้ว และไม่สามารถใช้ร่วมกับส่วนลดอื่นได้
...
### Feature เด่น
- มีส่วนลดสูงเมื่อเทียบกับราคาปกติที่ระบุในตาราง
...
### Feature เด่น
- มีตัวเลือก "no H-Test" (ไม่รวมการตรวจไวรัสตับอักเสบ) ซึ่งลดราคา ~1,000 บาท
- Essential เป็นแพ็กเกจเริ่มต้น ราคา 3,500 บาท
...
### Feature เด่น
- ให้บริการโดยแพทย์เฉพาะทางด้านเวชศาสตร์ป้องกัน
- ใช้เทคโนโลยีทางการแพทย์ในการตรวจสุขภาพ
...
### Feature เด่น
- ราคาเริ่มต้น 2,392 บาท ซึ่งต่ำสุดในกลุ่มโรงพยาบาลเอกชนที่แสดงในตาราง
- มีแพ็กเกจ LGBTQ+ (Alternative Couples)
- Fast Track Dengue Vaccine 3,700 บาท

---

<a id="9-โรงพยาบาลธนบุรีเจริญเมือง"></a>
...
> ⚠️ ข้อมูลนี้ระบุวันสิ้นสุด 31 มกราคม 2026 ควรสอบถามโรงพยาบาลว่ามีโปรโมชั่นรอบใหม่หรือไม่
...
### Feature เด่น
- มีส่วนลด **50-70%** จากราคาปกติที่ระบุ
- เป็นโปรแกรมสำหรับ Expat ควรสอบถามเงื่อนไขสิทธิ์ใช้บริการก่อนจอง
...
- ดูรายละเอียดแพ็กเกจเพิ่มเติมได้จากภาพโปรโมชั่น
...
|--:|:--|:--|:--|
| 14 | สมิติเวช ธนบุรี | Wellness Center 2026 | ตรวจสอบรายละเอียดบนเว็บไซต์โรงพยาบาล |
...
| 19 | ศิครินทร์ (Sikarin) | Light / Silver / Gold | ดู GoWabi |
| 20 | เซนต์หลุยส์ | Health Check-up Program | ติดต่อโดยตรง |
| 21 | BNH | Annual Check-up / Anytime 24/7 | ตรวจสอบรายละเอียดบนเว็บไซต์โรงพยาบาล |
...
<a id="️-โปรที่กำลังหมดเร็วๆ-นี้"></a>
<a id="-โปรที่กำลังหมดเร็วๆ-นี้"></a>

## ⚠️ วันสิ้นสุดโปรโมชั่นตามข้อมูลเดิม

| โรงพยาบาล | หมดอายุ | เวลาที่เหลือ ณ วันที่รวบรวมข้อมูล |
|:--|:--|--:|
...
_ข้อมูลที่รวบรวมจาก 21 โรงพยาบาล ณ 9 พ.ค. 2026_
...
- **เจ้าพระยา P4A (10,900)**: สำหรับอายุ 30-45 มี Tumor Markers 4 ตัว ร่วมกับอัลตราซาวนด์ ตรวจอุจจาระ ตรวจตา และตรวจหัวใจ ในราคาต่ำกว่า 11,000
- **บำรุงราษฎร์ Regular (7,000)**: แพ็กเกจพื้นฐานที่ไม่รวม Tumor Markers และอัลตราซาวนด์
...
- **เจ้าพระยา P3A (5,400 บาท)** — รวม ThinPrep Pap, ตรวจตา, HbA1c และ EKG อยู่ในชุดตรวจ 13 รายการตามข้อมูลบนเว็บไซต์
- **พญาไท 2 อายุ 35-49 (14,500 บาท)** — มี EST, Mammogram, ThinPrep, CA 125, CA 19-9 และอัลตราซาวนด์ รวมอยู่ในชุดตรวจ 28 รายการ
- **เจ้าพระยา P5A (13,200 บาท)** — มี Tumor Markers ได้แก่ CEA, AFP, CA19-9, CA125 และ CA15-3 พร้อม ThinPrep ตรวจตา และอัลตราซาวนด์
- **บำรุงราษฎร์ Regular หญิง (10,500 บาท)** — พื้นฐานดีแต่ไม่มี Mammogram / Pap Smear ใน Regular
- **กรุงเทพ Prestige หญิง (23,000 บาท)** — เพิ่ม Breast Ultrasound, HPV, ABI และการตรวจตา จึงมีรายการตรวจสุขภาพสตรีหลายด้าน
