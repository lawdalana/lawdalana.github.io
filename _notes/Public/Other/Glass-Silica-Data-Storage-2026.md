...
> **ทำไมถึงเก็บได้หลาย level?** เพราะ voxel ไม่ได้เก็บแค่ "มี/ไม่มี" แต่เก็บ **สมบัติทางแสง** ได้หลายค่า — เช่น มุม polarization, ความแรงของ retardance, การเปลี่ยน refractive index — แต่ละค่าสามารถแบ่งเป็น multiple levels ได้
